...
public class ClientControllerIntegTest {
    ...
    public void setMockMvc() {
        mockMvc = MockMvcBuilders
                ...
                .apply(springSecurity()) // Apply the spring security filters
                .build();
    }
    ...
    public void getLoggedInUserClients() throws InterruptedException {
        ...
        RestPage<MyPair<String, String>> clientPage = new RestPage<>(clientIds, 1,1,1, 1);
    ...
    public void setUsersAndsersInClientOrganizationUserRole(MockWebServer mockWebServer) throws Exception {
        ...
        RestPage<Role> CustomRestPage = new RestPage<>(roles, 1, 1, 1, 1);
        ...
        Assertions.assertThat(recordedRequest.getPath())
                .startsWith("/roles/clients/"+oauthClient.getId()+"/organizations/"+organizationId+"/users/roles");
        Assertions.assertThat(recordedRequest.getMethod()).isEqualTo("PUT");
